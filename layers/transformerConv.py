...
class TransformerConv(MessagePassing):
    ...
    def message(self, x_i: Tensor, x_j: Tensor, edge_attr: OptTensor,
        ...
        # A = torch.rand((x_i.shape[0], self.heads, self.out_channels, self.out_channels))
        # AK = torch.einsum('bhij, bhj -> bhi', A, key) # NOTE check if it is 'bhij, bhi -> bhj'
        # print(AK.shape, (AK*query).shape, key.shape)
